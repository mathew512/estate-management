...
* The original package name 'com.kasa.estate-management' is invalid and this project uses 'com.kasa.estate_management' instead.
...
* [Flyway Migration](https://docs.spring.io/spring-boot/4.2.0-SNAPSHOT/how-to/data-initialization.html#howto.data-initialization.migration-tool.flyway)
